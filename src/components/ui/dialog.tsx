 ...
 * inside while open, returned to the trigger on close, the rest of the page is
 * marked aria-hidden, and Escape closes. Every DialogContent must contain a
 * DialogTitle — Radix warns loudly otherwise, because a dialog with no
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'max-h-[calc(100dvh-2rem)] overflow-y-auto border bg-background p-6 shadow-lg sm:rounded-lg',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
