...
import { getCategoryTree, productCardSelect } from '@/server/catalogue';
 ...
 * Homepage.
 *
 * Statically rendered and revalidated every 10 minutes. The homepage is the
 * most-requested page on the site and its content (featured products, banner
 * copy) changes at editorial pace, not per-request — so serving a cached HTML
 * document and refreshing it in the background is both faster and dramatically
 * cheaper than rendering it for every visitor.
 */
