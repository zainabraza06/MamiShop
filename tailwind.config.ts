 ...
 * Palette: warm neutrals (sand/linen), muted rose accent, deep ink text.
 * All colours are CSS variables so themes stay swappable and WCAG-AA contrast
 * pairs are enforced in one place (see src/app/globals.css).
 */
const config: Config = {
  darkMode: ['class'],
